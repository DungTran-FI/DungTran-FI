...
|------------------------------|-------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|
| **Machine Learning**          | [From Reviews to Insights: Applying Machine Learning Models for Sentiment Rating Classification](https://github.com/DungTran-FI/From-Reviews-to-Insights-Applying-Machine-Learning-Models-for-Hotel-Sentiment-Rating-Classification/blob/main/DungTran%20-%20Hotel%20Rating%20Classification.ipynb) | Leveraged supervised machine learning models, together with resampling techniques (SMOTE, ADASYN, Random Under-Sampling) to automate the classification of hotel customer reviews into Low and High ratings based on the analysis of review texts and other hotel features. Conducted hyperparameter tuning using Bayesian Optimization to further enhance the model’s predictive accuracy. Achieved 89.74% accuracy. | Python, Supervised Machine Learning Algorithms, Sentiment Analysis  |
|    | [TripAdvisor Hotel Review Analysis: Predicting Review Influence with Machine Learning](https://github.com/DungTran-FI/TripAdvisor-Hotel-Review-Analysis-Predicting-Review-Influence-with-Machine-Learning)                                                 | Developed machine learning models to predict the influence of review authors in real-life and online environments using Weka toolkit, providing actionable insights for marketing optimization and customer engagement. Achieved 85.90% accuracy. | Machine Learning, Data Processing, Weka     |
